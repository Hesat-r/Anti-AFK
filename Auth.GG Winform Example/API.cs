...
namespace Auth.GG_Winform_Example
{
                    ...
                    switch (response[2])
                    {
                        case "success":
                            ...
                            if (ApplicationSettings.DeveloperMode)
                            {
                                ...
                                {
                                    Title = "Update",
                                    Message = "Neues Update Verfügbar Update Wird Nun Heruntergeladen",
                                    Type = NotificationType.Information
                                });
                                Thread.Sleep(1500);
                                File.Create(Environment.CurrentDirectory + "/Version.log").Close();
                                string hash = Security.Integrity(Process.GetCurrentProcess().MainModule.FileName);
                                File.WriteAllText(Environment.CurrentDirectory + "/.log", hash);
                            ...
                            else
                            {
                                ...
                                if (ApplicationSettings.Version != "1.4")
                                {
                                    notificationManager.Show(new NotificationContent
                                    {
                                        Title = $"Update {ApplicationSettings.Version} Verfügbar",
                                        Message = $"Update {ApplicationSettings.Version} ist nun Verfügbar und wird Heruntergeladen",
    ...
    internal class API
    {
        ...
        public static bool AIOLogin(string AIO)
        {
            ...
            {
                MessageBox.Show("Anmelde Daten Fehlen!", ApplicationSettings.Name, MessageBoxButton.OK, MessageBoxImage.Error);
                Process.GetCurrentProcess().Kill();
            }
            string[] response = new string[] { };
            using (WebClient wc = new WebClient())
                ...
                try
                {
                    ...
                    switch (response[2])
                    {
                        ...
                        case "time_expired":
                            notificationManager.Show(new NotificationContent
                            {
                                Title = "Subscription Ende",
                                Message = "Deine Subscription ist Abgelaufen!",
                    ...
                    switch (response[2])
                    {
                        ...
                        case "invalid_details":
                            notificationManager.Show(new NotificationContent
                            {
                                ...
                                Message = "Dein Benutzername oder Passwort ist falsch",
                                Type = NotificationType.Error
                            });
                        ...
                        case "time_expired":
                            notificationManager.Show(new NotificationContent
                            {
                                Title = "Subscription Abgelaufen",
                                Message = "Dein Subscription ist Abgelaufen",
                                Type = NotificationType.Error
                            });
                            Security.End();
                            return false;
                        case "hwid_updated":
                            ...
                            {
                                Title = "HWID Erneuert",
                                Message = "Dein Hard-Ware-Identification wurde erneuert",
                                Type = NotificationType.Information
                            });
                            Security.End();
                            return false;
                        case "invalid_hwid":
                            notificationManager.Show(new NotificationContent
                            {
                                Title = "Falscher Account",
                                Message = "Dieser Account Gehört Jemand Anderem",
                ...
                try
                {
                    ...
                    switch (response[2])
                    {
                        ...
                        case "invalid_license":
                            notificationManager.Show(new NotificationContent
                            {
                                Title = "Falscher License Code",
                                Message = "Dieser License Code Exestiert nicht",
                                Type = NotificationType.Error
                            });
                            return false;
                        case "email_used":
                            ...
                            {
                                Title = "Falsche Email",
                                Message = "Diese Email Exestiert Bereits",
                                Type = NotificationType.Error
                            });
                            Security.End();
                            return false;
                        case "invalid_username":
                            notificationManager.Show(new NotificationContent
                            {
                                Title = "Falscher Benutzername",
                                Message = "Flascher Benutzername Wurde Eingegeben",
                                Type = NotificationType.Error
                            });
                            Security.End();
                            return false;
